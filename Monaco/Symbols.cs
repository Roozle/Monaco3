...
namespace Monaco
{
    internal class Symbols
    {
        ...
        {
            var BookPrices = _client.Get24HPricesList().Data.Where(x => x.Symbol.Contains("BTC") && x.QuoteVolume > 500 && !x.Symbol.Contains("BNB")).OrderByDescending(x => x.QuoteVolume).ToList();
